    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          <Text style={styles.currentLocation}>{city}, {country}</Text>
          ...
          {mode === 'device' ? (
            ...
            <View style={styles.manualLocationSection}>
              ...
              <View style={styles.mapPreview}>
                ...
                <Text style={styles.mapPreviewText}>Map preview for {city}, {country}</Text>
              </View>
            </View>
          )}
        </View>
        ...
        <View style={styles.card}>
          <View style={styles.toggleRow}>
            <View style={styles.toggleContent}>
              <Text style={styles.toggleTitle}>Share approximate location (city only)</Text>
            </View>
            <Switch
              value={approximate}
        ...
        <View style={styles.card}>
          ...
          <View style={styles.limitItem}>
            ...
            <Text style={styles.limitText}>You can change location once every 24h</Text>
          </View>
          <View style={styles.limitItem}>
